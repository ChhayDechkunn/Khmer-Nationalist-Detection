...
def print_to_file(*args, filename='pre_pseudo_weight_CV_pride.txt', mode='a', **kwargs):
    with open(filename, mode, encoding='utf-8') as f:
        print(*args, file=f, **kwargs)

# Redirect stdout to the file
sys.stdout = open('pre_pseudo_weight_CV_pride.txt', 'w')
...
with open(f'lr_tfidf_binary_weighted_model_pride.pkl', 'wb') as file:
...
with open(f'nb_tfidf_binary_weighted_model_pride.pkl', 'wb') as file:
...
with open(f'rf_tfidf_binary_weighted_model_pride.pkl', 'wb') as file:
...
with open(f'svm_tfidf_binary_weighted_model_pride.pkl', 'wb') as file:
